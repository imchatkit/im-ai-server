...
CREATE TABLE `im_conversation`  (
  ...
  `ext` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '扩展字段',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '聊天房间基础表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `im_error_log`  (
  ...
  `error_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '错误码',
...
CREATE TABLE `im_friend`  (
  ...
  `status` tinyint NULL DEFAULT 1 COMMENT '状态: 1-正常 2-删除 3-拉黑',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `im_group_announcement`  (
  ...
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间，精确到毫秒',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `im_msg`  (
  ...
  `at` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '艾特他人,传入客户���id数组',
  `msg_status` int NULL DEFAULT 1 COMMENT '消息状态 \n1正常  2已撤回\n',
...
CREATE TABLE `im_tenant`  (
  ...
  `tenant_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '租户唯一标识码',
  `industry_type` tinyint NULL DEFAULT NULL COMMENT '行业类型',
  `tenant_status` tinyint NULL DEFAULT NULL COMMENT '状态',
  `expire_time` timestamp NULL DEFAULT NULL COMMENT '服务到期时间',
...
CREATE TABLE `im_usage_statistics`  (
  ...
  `active_user_count` int NULL DEFAULT 0 COMMENT '活跃用户��',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_tenant_date`(`fk_tenant_id` ASC, `date_key` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '使用量统计表' ROW_FORMAT = DYNAMIC;
