...
public class ImGroupAnnouncementController extends BaseController {
     ...
     * 查询群公告列表
     */
    @SaCheckPermission("imai:groupAnnouncement:list")
    @GetMapping("/list")
     ...
     * 导出群公告列表
     */
    @SaCheckPermission("imai:groupAnnouncement:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("imai:groupAnnouncement:query")
    @GetMapping("/{id}")
     ...
     * 新增群公告
     */
    @SaCheckPermission("imai:groupAnnouncement:add")
     ...
     * 修改群公告
     */
    @SaCheckPermission("imai:groupAnnouncement:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("imai:groupAnnouncement:remove")
