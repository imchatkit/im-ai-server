...
public class ImSyncController extends BaseController {
     ...
     * 查询多端同步列表
     */
    @SaCheckPermission("imai:sync:list")
    @GetMapping("/list")
     ...
     * 导出多端同步列表
     */
    @SaCheckPermission("imai:sync:export")
     ...
     * @param id 主键
     */
    @SaCheckPermission("imai:sync:query")
    @GetMapping("/{id}")
     ...
     * 新增多端同步
     */
    @SaCheckPermission("imai:sync:add")
     ...
     * 修改多端同步
     */
    @SaCheckPermission("imai:sync:edit")
     ...
     * @param ids 主键串
     */
    @SaCheckPermission("imai:sync:remove")
